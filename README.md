...
## 🕹️ Link YESCOIN:[ Click](https://t.me/theYescoin_bot/Yescoin?startapp=OMqdcL)

## 🛠️ Hướng dẫn cài đặt

> Yêu cầu đã cài đặt NodeJS

- Bước 1: Tải về phiên bản mới nhất của tool [tại đây ⬇️](https://github.com/donguyen82/Yescoin/archive/refs/heads/main.zip)
...
| Lệnh                    | Chức năng                               |
| ----------------------- | --------------------------------------- |
| `npm run yescoin`       | Dùng để chạy chơi game không dùng proxy |
| `npm run yescoin-proxy` | Dùng để chạy chơi game có dùng proxy    |
...
<details>
<summary>v1.0.0 - 📅 07/09/2024</summary>
